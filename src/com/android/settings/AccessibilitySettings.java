...
public class AccessibilitySettings extends SettingsPreferenceFragment implements DialogCreatable,
	...
	//[Advantech] remove rotation preference 
        if (SystemProperties.get("adv.auto_rotate.disabled").equals("true")) {
        	if (mSystemsCategory != null && mToggleLockScreenRotationPreference != null) 
                	mSystemsCategory.removePreference(mToggleLockScreenRotationPreference);
	}

	//[Advantech] remove text-to-speech perference
	mTTSSettingsPreferenceScreen =
		(PreferenceScreen) findPreference(TTS_SETTINGS_PREFERENCE);
	if (SystemProperties.get("adv.text_to_speech.disabled").equals("true")) {
		if (mSystemsCategory != null && mTTSSettingsPreferenceScreen != null)
