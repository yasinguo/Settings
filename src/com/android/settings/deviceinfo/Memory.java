...
//[Advantech add]
    private String confirm_unmount_text;
    private String confirm_unmount_title;
    private String unmount_inform_text;
//[Advantech end]
	...
	//[Advantech add]
        if (SystemProperties.get("adv.massstorage.disabled").equals("false")) 
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        for (StorageVolumePreferenceCategory category : mCategories) {
	       ...
	       //[Advantech add]
	       switch (StorageVolumePreferenceCategory.deviceType(volume)) {
	       		case 1://sd card
				confirm_unmount_text = (String)getResources().getText(R.string.dlg_confirm_unmount_text);
				confirm_unmount_title = (String)getResources().getText(R.string.dlg_confirm_unmount_title);
				unmount_inform_text = (String)getResources().getText(R.string.unmount_inform_text);
	                	break;
	                case 2://usb storage
				confirm_unmount_text = (String)getResources().getText(R.string.dlg_confirm_unmount_text_usb);
				confirm_unmount_title = (String)getResources().getText(R.string.dlg_confirm_unmount_title_usb);
				unmount_inform_text = (String)getResources().getText(R.string.unmount_inform_text_usb);
	                	break;
			case 3://sata disk
				confirm_unmount_text = (String)getResources().getText(R.string.dlg_confirm_unmount_text_sata);
				confirm_unmount_title = (String)getResources().getText(R.string.dlg_confirm_unmount_title_sata);
				unmount_inform_text = (String)getResources().getText(R.string.unmount_inform_text_sata);
				break;
	                default:
	                        break;
	                 }
    ...
    public Dialog onCreateDialog(int id) {
        ...
        case DLG_CONFIRM_UNMOUNT:
                return new AlertDialog.Builder(getActivity())
                    .setTitle(confirm_unmount_title)
                    .setPositiveButton(R.string.dlg_ok, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            doUnmount();
                        }})
                    .setNegativeButton(R.string.cancel, null)
                    .setMessage(confirm_unmount_text)
                    .create();
    ...
    private void doUnmount() {
        ...
        Toast.makeText(getActivity(), unmount_inform_text, Toast.LENGTH_SHORT).show();
