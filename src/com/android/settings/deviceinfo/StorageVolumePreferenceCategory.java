...
//[Advantech add]
    ...
    private String eject_summary;
    private String mount;
    private String insert_summary;
//[Advantech end]
...
//[Advantech add]
        switch (deviceType(mVolume)) {
		case 1://sd card
		        eject          = (String)this.getContext().getResources().getText(R.string.sd_eject);	
		        eject_summary  = (String)this.getContext().getResources().getText(R.string.sd_eject_summary);	
		        mount          = (String)this.getContext().getResources().getText(R.string.sd_mount);	
		        insert_summary = (String)this.getContext().getResources().getText(R.string.sd_insert_summary);	
			break;
	    	case 2://usb storage 
		        eject          = (String)this.getContext().getResources().getText(R.string.usb_eject);	
		        eject_summary  = (String)this.getContext().getResources().getText(R.string.usb_eject_summary);	
		        mount          = (String)this.getContext().getResources().getText(R.string.usb_mount);	
		        insert_summary = (String)this.getContext().getResources().getText(R.string.usb_insert_summary);	
			break;
		case 3://sata disk
			eject          = (String)this.getContext().getResources().getText(R.string.sata_eject);
			eject_summary  = (String)this.getContext().getResources().getText(R.string.sata_eject_summary);
			mount          = (String)this.getContext().getResources().getText(R.string.sata_mount);
			insert_summary = (String)this.getContext().getResources().getText(R.string.sata_insert_summary);
			break;
		default:
			break;
	}
//[Advantech end]
        ...
        if (isRemovable) {
            mMountTogglePreference.setTitle(eject);
            mMountTogglePreference.setSummary(eject_summary);
...
//[Advantech add]
    public static int deviceType(StorageVolume eVolume) {
	    if (eVolume == null)   return -1;
	    else {
	    	if (eVolume.getPath().indexOf("extsd") != -1 )
			   return  1;
	    	else if (eVolume.getPath().indexOf("udisk") != -1)
			   return  2;
		else if (eVolume.getPath().indexOf("sata") != -1)
			   return  3;
		else
			   return -1;
	    }
