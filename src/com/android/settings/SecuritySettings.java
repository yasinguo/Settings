...
public class SecuritySettings extends SettingsPreferenceFragment
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        // [Advantech] Remove Onwer Info
        if (SystemProperties.get("adv.users.disabled").equals("true")) {
            PreferenceGroup securityCategory = (PreferenceGroup)
                        root.findPreference(KEY_SECURITY_CATEGORY);
            Preference ownerInfoPref = findPreference(KEY_OWNER_INFO_SETTINGS);
            if (securityCategory != null && ownerInfoPref != null) {
                securityCategory.removePreference(ownerInfoPref);
            }
        }
        

	// [Advantech] disable encrypt settings
	if (!SystemProperties.get("adv.encrypt.disabled").equals("true")) {
        if (mIsPrimary) {
        ...
        // [Advantech] Remove Automatically lock Setting 
        if (SystemProperties.get("adv.power_key.disabled").equals("true")) {
	        PreferenceGroup securityCategory = (PreferenceGroup)
        	            root.findPreference(KEY_SECURITY_CATEGORY);
        	if (securityCategory != null && mLockAfter != null) {
        ...
        // [Advantech] Remove Power button instantly locks Setting  
        if (SystemProperties.get("adv.power_key.disabled").equals("true")) {
	        PreferenceGroup securityCategory = (PreferenceGroup)
        	            root.findPreference(KEY_SECURITY_CATEGORY);
        	if (securityCategory != null && mPowerButtonInstantlyLocks != null) {
        		securityCategory.removePreference(mPowerButtonInstantlyLocks);
        	}
	}
