    ...
    private void updateHeaderList(List<Header> target) {
        ...
        while (i < target.size()) {
            ...
            if (id == R.id.operator_settings || id == R.id.manufacturer_settings) {
                ...
                // [Advantech] Remove Battery Settings if the property is enabled.
                if (SystemProperties.get("adv.battery.disabled").equals("true")) {
                    target.remove(i);
                }
                ...
                // [Advantech] Remove Users Settings if the property is enabled.
